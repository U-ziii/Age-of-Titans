...
local function runMainScript()
    ...
    local Games = loadstring(game:HttpGet("https://raw.githubusercontent.com/sharkindigo12/ATTACK-OF-TITAN/refs/heads/main/obfuscated_script-1764221856270.lua.txt"))()
